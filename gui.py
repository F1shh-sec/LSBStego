...
def encode():
    ...
    upload_button = tk.Button(top, text="Upload File", command=top.quit)
    upload_button.pack(pady=10)


    selected_file_name = upload_file()
    fileName = "Selected File Name: " + selected_file_name
    file_label = tk.Label(top, text= fileName)
    file_label.pack(pady=10)
    
    messageIn = tk.StringVar()
    labelf = tk.Label(top, text = 'Enter Your Message').pack()
    ...
    encoButton = tk.Button(top, text="Finish", command=lambda: encode_enc(stego_file, messageIn.get()))
    encoButton.pack()
...
def main():
    ...
    encrypt_button = tk.Button(window, text="Encrypt", command=encode)
    encrypt_button.pack()

    decrypt_button = tk.Button(window, text="Decrypt", command=decode)
    decrypt_button.pack()
